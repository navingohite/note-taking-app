...
<div class="page-content container note-has-grid">
    <ul class="nav nav-pills p-3 bg-white mb-3 align-items-center">
        <li class="nav-item">
            <a href="javascript:void(0)" class="nav-link btn-info rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2 active" id="all-category">
                <i class="icon-layers mr-1"></i><span class="d-none d-md-block">E-Notes</span>
            </a>
        </li>
        ...
        <li class="nav-item ml-auto">
            <a href="javascript:void(0)" class="nav-link btn-info rounded-pill d-flex align-items-center px-3" id="add-notes"> <i class="icon-note m-0"></i><h5><span class="d-none d-md-block font-14"> + </span></h5></a>
        </li>
        &nbsp;&nbsp;&nbsp;
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title text-white">Create Notes</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-outline-danger btn-sm" data-dismiss="modal">Clear</button>
                    <button id="btn-n-add" class="btn btn-outline-info btn-sm" disabled="disabled">Add</button>
                </div>
            </div>
        </div>
    </div>
